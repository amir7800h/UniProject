...
namespace Application.Dtos
{
    public class PaginatedItemsDto<TEntity> where TEntity : class
    {
        ...
        public bool HasNextiosPage
        {
            get { return (PageIndex < Pager.TotalPages); }
        }

    }
    /// <summary>
    /// الگوریتم نشان دادن تعداد دلخواه صفحه
    /// </summary>
    public class Pager
    {
        public Pager(long totalItems, int currentPage=1, 
            int pageSize=10, int maxPages=5)
        {
